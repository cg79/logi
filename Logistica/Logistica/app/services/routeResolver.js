...
define([], function () {
    ...
    var routeResolver = function () {
        ...
        this.routeConfig = function () {
            var viewsDirectory = '/Logistica/app/controllers/',
                controllersDirectory = '/Logistica/app/controllers/',
        ...
        this.route = function (routeConfig) {
            ...
            var resolve = function (baseName, path, controllerAs, secure) {
                ...
                var isSecure = (secure == undefined) ? false : secure;
                routeDef.secure = isSecure;
