...
{
    public partial class ConsumerFormResponse : Form
    {
        public ConsumerFormResponse()
        {
            InitializeComponent();
        }
        ...
        RabbitMQResponseConsumer consumer = null;
        ...
        internal void Start()
        {
            action = new Action<string>(a => receiveMessage(a.ToJSON()));

            consumer = new RabbitMQResponseConsumer();
